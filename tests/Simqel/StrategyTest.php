...
class StrategyTest extends \PHPUnit_Framework_TestCase {
    ...
    private function getStrategyMock() {
    	$settings = $this->getMock('Simqel\Settings');
    	$connection = $this->getMockForAbstractClass('Simqel\Connection_PDO', array($settings));
    	return $this->getMock('Simqel\Strategy_MySQL', array('escapeIdentifier'), array($connection));    	
    }

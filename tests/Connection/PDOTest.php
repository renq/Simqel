...
/**
 * Class SqlConnectionPDOTest
 * @package Simqel\Tests
 */
class SqlConnectionPDOTest extends TestCase
{
    ...
    /**
     * @expectedException \Simqel\BindException
     */
    ...
    {
        /* @var $connection Connection_PDO | \PHPUnit_Framework_MockObject_MockObject */
